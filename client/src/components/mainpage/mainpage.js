      ...
      <div>
        ...
        <nav>
          <ul>
            ...
            <li><a href="/register">Admin Login</a></li>
          </ul>
        ...
        <section id="testimonials">
          <div className="testimonials_container">
            ...
            <div className="testimonial-cards">
              ...
              <div className="testimonial-card">
                <img src={Bg2} alt="Student 2" />
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla euismod eros vel orci vestibulum, vel sollicitudin sapien hendrerit. Praesent non risus non metus finibus ullamcorper eu in lectus.</p>
                <h4>Jane Doe</h4>
                <p className="title">Business Administration Student</p>
              </div>
            </div>
          </div>
        </section>
